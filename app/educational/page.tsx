...
export default function EducationalPage() {
  const packages = getPackagesByCategory('educational', 24)
        ...
        <div className="relative h-[60vh] min-h-[500px] w-full">
          ...
          <div className="absolute bottom-0 left-0 w-full p-8 md:p-16">
            <div className="container mx-auto max-w-7xl">
              <span className="inline-block px-4 py-1.5 bg-[#1a1f4e] text-white text-sm font-bold tracking-wider uppercase rounded-full mb-6 shadow-lg border border-white/20">
                Learn & Explore
              </span>
              ...
              <p className="text-xl text-white/90 max-w-2xl font-light drop-shadow-md">
                Enriching travel experiences designed for students, institutions, and curious minds. Dive into history, culture, and heritage.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl mt-12 relative z-10">
          ...
          <div className="mb-24">
            <div className="flex justify-between items-end mb-10 border-b border-gray-200 pb-4">
              <div>
                <h2 className="text-3xl md:text-4xl font-serif text-[#1a1f4e] mb-2">Heritage & Learning Escapes</h2>
            ...
            {packages.length === 0 ? (
              <div className="text-center py-20 bg-white rounded-2xl border border-gray-100">
                <h3 className="text-2xl font-bold text-[#1a1f4e] mb-2">New Educational Tours Coming Soon</h3>
                <p className="text-gray-500">We are currently curating the best educational experiences. Please check back later.</p>
              </div>
            ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative h-64 w-full overflow-hidden">
                        <Image
                          src={`https://image.pollinations.ai/prompt/heritage,${pkg.title.replace(/\s+/g, ',')},${countryName}?width=800&height=600&nologo=true`}
                          alt={pkg.title}
                          fill
                      ...
                      <div className="p-6 flex flex-col flex-grow">
                        ...
                        <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                          ...
                          <div className="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center group-hover:bg-[#1a1f4e] transition-colors">
